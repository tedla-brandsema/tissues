...
NON_SECRET_ENV="TISSUES_SERVER_READ_TIMEOUT=60s,TISSUES_SERVER_WRITE_TIMEOUT=60s,TISSUES_AUTH_ENABLED=true,TISSUES_AUTH_ISSUER_URL=${PUBLIC_ORIGIN},TISSUES_AUTH_MCP_RESOURCE_URL=${PUBLIC_ORIGIN}/mcp,TISSUES_AUTH_CLIENT_ID=tissues,TISSUES_AUTH_CLIENT_REDIRECT_URI=${PUBLIC_ORIGIN}/tissues/auth/callback,TISSUES_AUTH_CLIENT_METADATA_URL_LIST=${CLIENT_METADATA_URL_LIST},TISSUES_AUTH_PROJECT_ID=${PROJECT_ID},TISSUES_AUTH_DATASTORE_NS=${AUTH_NAMESPACE},TISSUES_AUTH_INSECURE_COOKIE=false,TISSUES_TISSUES_ENABLED=true,TISSUES_TISSUES_STORAGE_PROJECT_ID=${PROJECT_ID},TISSUES_TISSUES_STORAGE_NAMESPACE=${TISSUES_NAMESPACE},TISSUES_TISSUES_ASSETS_BUCKET=${TISSUES_ASSET_BUCKET},TISSUES_TISSUES_AUTH_ENABLED=true,TISSUES_TISSUES_AUTH_BROKER_URL=${PUBLIC_ORIGIN},TISSUES_TISSUES_AUTH_CLIENT_ID=tissues,TISSUES_TISSUES_AUTH_REDIRECT_URI=${PUBLIC_ORIGIN}/tissues/auth/callback,TISSUES_TISSUES_AUTH_INSECURE_COOKIE=false"
